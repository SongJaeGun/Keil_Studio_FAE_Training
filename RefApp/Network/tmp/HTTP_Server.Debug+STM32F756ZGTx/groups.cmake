...
# group Network
add_library(Group_Network OBJECT
  "${SOLUTION_ROOT}/HTTP_Server/HTTP_Server.c"
  "${SOLUTION_ROOT}/HTTP_Server/HTTP_Server_CGI.c"
  "${SOLUTION_ROOT}/HTTP_Server/Web.c"
)
target_include_directories(Group_Network PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_INCLUDE_DIRECTORIES>
)
target_compile_definitions(Group_Network PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_COMPILE_DEFINITIONS>
)
add_library(Group_Network_ABSTRACTIONS INTERFACE)
target_link_libraries(Group_Network_ABSTRACTIONS INTERFACE
  ${CONTEXT}_ABSTRACTIONS
)
target_compile_options(Group_Network PUBLIC
  $<TARGET_PROPERTY:${CONTEXT},INTERFACE_COMPILE_OPTIONS>
)
target_link_libraries(Group_Network PUBLIC
  Group_Network_ABSTRACTIONS
)
set_source_files_properties("${SOLUTION_ROOT}/HTTP_Server/Web.c" PROPERTIES
  GENERATED TRUE
)
